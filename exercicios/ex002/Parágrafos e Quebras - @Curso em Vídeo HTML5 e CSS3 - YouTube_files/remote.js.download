...
Ga:["ytp-button","ytp-mdx-privacy-popup-cancel"],ya:"Cancelar"},{G:"button",Ga:["ytp-button","ytp-mdx-privacy-popup-confirm"],ya:"Confirmar"}]}]}]});this.i=new g.sL(this,250);this.cancelButton=this.Fa("ytp-mdx-privacy-popup-cancel");this.confirmButton=this.Fa("ytp-mdx-privacy-popup-confirm");g.I(this,this.i);this.T(this.cancelButton,"click",this.u);this.T(this.confirmButton,"click",this.B)},D9=function(a){g.W.call(this,{G:"div",
...
b=g.T(b,128)?g.lI("Erro em $RECEIVER_NAME",c):b.Dc()||g.T(b,4)?g.lI("Reproduzindo em $RECEIVER_NAME",c):g.lI("Conectado a $RECEIVER_NAME",c);a.Sa("statustext",b);a.i.show()}else a.i.hide()},E9=function(a,b){g.MP.call(this,"Reproduzir em",0,a,b);
...
break;case -1:this.Tb(new g.NJ(64));break;case -1E3:this.Tb(new g.NJ(128,{errorCode:"mdx.remoteerror",errorMessage:"Este v\u00eddeo n\u00e3o est\u00e1 dispon\u00edvel para reprodu\u00e7\u00e3o remota."}))}a=R8(this.Sb).trackData;var b=this.C;(a||b?a&&b&&a.trackName==b.trackName&&a.languageCode==b.languageCode&&a.languageName==b.languageName&&a.kind==b.kind:1)||(this.C=a,lVa(this,a));a=R8(this.Sb);-1===a.volume||Math.round(this.J.getVolume())===a.volume&&this.J.isMuted()===a.muted||this.X.isActive()||
this.FO()}else kVa(this)};
...
E9.prototype.dj=function(a){return"cast-selector-receiver"===a?"Elenco...":this.zo[a].name};
