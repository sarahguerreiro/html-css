...
g.k.uE=function(){this.tooltip=new g.wQ(this.player,this);g.I(this,this.tooltip);g.JM(this.player,this.tooltip.element,4);this.tooltip.scale=.6;this.uc=new g.PN(this.player);g.I(this,this.uc);this.Dg=new g.W({G:"div",L:"ytp-miniplayer-scrim"});g.I(this,this.Dg);this.Dg.Da(this.element);this.T(this.Dg.element,"click",this.mA);var a=new g.W({G:"button",Ga:["ytp-miniplayer-close-button","ytp-button"],W:{"aria-label":"Fechar"},U:[g.QK()]});g.I(this,a);a.Da(this.Dg.element);this.T(a.element,"click",this.Di);
...
Ga:["ytp-miniplayer-close-button","ytp-button"],W:{"aria-label":"Fechar"},U:[g.QK()]});g.I(this,a);a.Da(this.aA.element);this.T(a.element,"click",this.Di);a=new g.W({G:"button",Ga:["ytp-miniplayer-replay-button","ytp-button"],W:{"aria-label":"Fechar"},U:[g.VK()]});g.I(this,a);a.Da(this.aA.element);this.T(a.element,"click",this.wV);this.T(this.player,"presentingplayerstatechange",this.Mc);this.T(this.player,"appresize",this.wb);this.T(this.player,"fullscreentoggled",this.wb);this.wb()};
